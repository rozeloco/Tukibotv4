...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: 'Esto tardara de 1 a 20 segundo.',
				success: '✔️ Listo ✔️',
  ...
  client.updatePresence(from, Presence.composing) 
	...
	case 'creador':
		...
		client.sendMessage(from, 'Arriba está el número del creador del bot Tukibot\n\nNO SOY UN BOT LPM 🥸\n\nAhi puedes resolver tus preguntas y errores :)\n\nby rosse',MessageType.text, { quoted: mek} )
